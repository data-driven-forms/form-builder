...
import { Box, TextField, FormControlLabel, Switch, InputLabel, MenuItem, FormControl, Select, IconButton } from '@material-ui/core';
            ...
            <tr>
              <td>
                <TextField
                  ...
                  onChange={({ target: { value } }) =>
                    handleOptionChange(value, index, 'label')
                  }
                  value={label || ''}
                  type="text"
                />
              ...
              <td>
                <TextField
                  ...
                  placeholder="Value"
                  onChange={({ target: { value } }) =>
                    handleOptionChange(value, index, 'value')
                  }
                  value={value || ''}
                  type="text"
                />
